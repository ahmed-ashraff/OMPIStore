...
void client(const int &rank) {
    ...
    logger.info("CREATE Response: " + string(success ? "Success" : "Failed") + ", Value: " + value);
    ...
    logger.info("READ Response: " + string(success2 ? "Success" : "Failed") + ", Value: " + value2);
    ...
    logger.info("UPDATE Response: " + string(success3 ? "Success" : "Failed") + ", Value: " + value3);
    ...
    logger.info("Second READ Response: " + string(success4 ? "Success" : "Failed") + ", Value: " + value4);
    ...
    // logger.info("DELETE Response: " + string(success5 ? "Success" : "Failed") + ", Value: " + value5);
